<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="Level2_Task1.about" %>
    ...
    <div class="about_main">
    	...
    	<div class="container">
    		<div class="creative_taital">
    			...
    			<div class="btn_main">
    			    <asp:Button runat="server" class="btn btn-dark btn-lg" id="get_Started" Text="Get started" onclick="getStarted_Click"></asp:Button>
    		    </div>
    		</div>    
    	</div>
        </div>
            ...
            <asp:View ID="View2" runat="server">
                <div class="container">
                    <h1 style="text-align:center;font-size:50px">Hi Ahmed</h1>
